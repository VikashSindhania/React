...
//Below code Related to HigherOrderComponents

//Higher Order Components
// Higher Order Components is used to Enhaance the Components.
//input - RestaurantCard => RestaurantCardPromoted
// HigherOrder Components at the enf of the day is a javascript function. They just take the components and return other components in outside and that component is the enhanced version of that input component.

export const withPromotedLabel = (RestaurantCard) => {
  //withPromotedLabel here is behaving as higher order components.
  return (props) => {
    //props coming from Body.js RestaurantCardPromoted
    // return here is behaving like a function which in retun giving JSX. here return is a functionall component.
    return (
      <div>
        <label className="absolute bg-black text-white m-p p-2 rounded-lg">
          Promoted
        </label>
...
// Below code is before the concept of HigherOrderComponent(all contents are discussed before Episode-11)
